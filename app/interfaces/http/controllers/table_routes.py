...
from app.interfaces.http.schemas.Table.update_table_schema import UpdateTableSchema
from app.application.services.Table.create_table_service import create_table_service
from app.application.services.Table.read_tables_service import get_tables_service
from app.application.services.Table.read_table_service import get_table_service
from app.application.services.Table.update_table_service import update_table
from app.application.services.Table.delete_table_service import delete_table_service
